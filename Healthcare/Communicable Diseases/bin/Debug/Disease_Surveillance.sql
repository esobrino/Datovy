...
GO
PRINT N'Creating Table [Other].[Case_Transmission_Mode_Code]...';
...
GO
PRINT N'Creating Default Constraint unnamed constraint on [Other].[Case_Transmission_Mode_Code]...';


GO
ALTER TABLE [Other].[Case_Transmission_Mode_Code]
    ADD DEFAULT 'COMMON' FOR [Tenant_ID];
