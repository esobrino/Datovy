...
INSERT INTO [Healthcare].[Lab_Test_Code] ([Code_ID], [Description], [CodeSet_Name]) VALUES
...
UPDATE [Healthcare].[Lab_Test_Code]
...
INSERT INTO [Healthcare].[Specimen_Type] ([Code_ID], [Description], [CodeSet_Name]) VALUES
...
INSERT INTO [Healthcare].[Lab_Result_Type] ([Code_ID], [Description], [CodeSet_Name]) VALUES
...
-- update this so we know where the code came from...
UPDATE [Healthcare].[Lab_Result_Type]
...
INSERT INTO [Healthcare].[Lab_Type] ([Code_ID], [Description], [CodeSet_Name]) VALUES
...
INSERT INTO [Healthcare].[Disease_Condition_Code] ([Code_ID], [Description], [CodeSet_Name]) VALUES
...
-- update this so we know where the code came from...
UPDATE [Healthcare].[Disease_Condition_Code]
...
INSERT INTO [Healthcare].[Clinical_Syndrome_Code] ([Code_ID], [Description], [CodeSet_Name]) VALUES
...
-- update this so we know where the code came from...
UPDATE [Healthcare].[Clinical_Syndrome_Code]
   SET Category_ID = 'Arboviral',
       Data_Owner_ID = 'CDC',
       Agency_Reporting_ID = 'CDC',
       Version_Number = 'v7'
...
INSERT INTO [Healthcare].[Clinical_Syndrome_Secondary_Code] ([Code_ID], [Description], [CodeSet_Name]) VALUES
...
-- update this so we know where the code came from...
UPDATE [Healthcare].[Clinical_Syndrome_Secondary_Code]
...
INSERT INTO [Healthcare].[Disease_Acquired_Jurisdiction_Code] ([Code_ID], [Description], [CodeSet_Name]) VALUES
...
-- update this so we know where the code came from...
UPDATE [Healthcare].[Disease_Acquired_Jurisdiction_Code]
   SET [Category_ID] = '',
       Data_Owner_ID = 'CDC',
       Agency_Reporting_ID = 'CDC',
       Version_Number = 'v3'
